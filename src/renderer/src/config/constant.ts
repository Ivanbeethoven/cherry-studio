import {
  DEFAULT_KNOWLEDGE_DOCUMENT_COUNT as SHARED_DEFAULT_KNOWLEDGE_DOCUMENT_COUNT,
  DEFAULT_KNOWLEDGE_THRESHOLD as SHARED_DEFAULT_KNOWLEDGE_THRESHOLD
} from '@shared/config/knowledge'

export const DEFAULT_TEMPERATURE = 1.0
export const DEFAULT_CONTEXTCOUNT = 5
export const DEFAULT_MAX_TOKENS = 4096
export const SYSTEM_PROMPT_THRESHOLD = 128
export const DEFAULT_KNOWLEDGE_DOCUMENT_COUNT = SHARED_DEFAULT_KNOWLEDGE_DOCUMENT_COUNT
export const DEFAULT_KNOWLEDGE_THRESHOLD = SHARED_DEFAULT_KNOWLEDGE_THRESHOLD
